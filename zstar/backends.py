    ...
    registry.register(
        MetadataBackend(
            BackendSpec(
                ...
                description="ZStar polarization, BEC, dielectric, and spectroscopy workflows.",
                capabilities={
                    "structure": _dims(0, 2, 3),
                    "forces": _dims(0, 2, 3),
                    "band_gap": _dims(2, 3),
                    "polarization": _dims(2, 3),
                    "density": _dims(2),
                    "born_effective_charge": _dims(2, 3),
                    "dielectric": _dims(2, 3),
                    "gamma_modes": _dims(0, 2, 3),
                    "ir": _dims(0, 2, 3),
                    "raman": _dims(0, 2, 3),
                },
            )
    ...
    registry.register(
        MetadataBackend(
            BackendSpec(
                name="cp2k",
                display_name="CP2K",
                description="Finite-displacement BEC and native molecular/bulk spectra.",
                capabilities={
                    "structure": _dims(0, 1, 2, 3),
                    "forces": _dims(0, 1, 2, 3),
                    "density": _dims(0, 1, 2, 3),
                    "dipole": _dims(0, 3),
                    "born_effective_charge": _dims(0, 3),
                    "dielectric": _dims(0, 3),
                    "gamma_modes": _dims(0, 3),
                    "ir": _dims(0, 3),
                    "raman": _dims(0, 3),
